<?php 
    ...
    if($resultado->num_rows === 1){ //Actualiza un registro existente
        ...
        $result=$connect->query("UPDATE control_riego SET riegos='".$riegos."', h_suelo='".$h_suelo."', temperatura='".$temperatura."',  h_relativa='".$h_relativa."', id_micro='".$id_micro."', WHERE fecha='".$fecha."' AND id_micro='".$id_micro."' ");
    }
